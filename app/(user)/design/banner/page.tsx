...
export default function BannerPickerPage() {
    ...
    <div className="max-w-[1280px] mx-auto space-y-xl">
      ...
      {!mounted ? (
        ...
        <div className="bg-white p-xl rounded-xl card-shadow border border-outline-variant/30 text-center">
          <Icon name="image_search" className="text-secondary text-[48px] mb-md" />
          <h3 className="text-h3 font-semibold mb-xs">아직 등록된 배너 템플릿이 없습니다</h3>
          <p className="text-body-base text-on-surface-variant">
            관리자가 배너 템플릿을 등록하면 여기에서 선택하여 제작할 수 있습니다.
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-3 gap-lg">
