...
import { getNoticeTemplate } from "@/lib/store/notice-templates";
...
export default function NoticeEditorPage() {
  ...
  const aspect = useMemo(() => {
    ...
    return template.height > 0 ? template.width / template.height : 1;
  }, [template]);
        ...
        <div className="col-span-8">
          <div className="bg-surface-container-low rounded-xl p-lg border border-outline-variant flex items-center justify-center min-h-[400px]">
            <div className="w-full max-w-full flex items-center justify-center">
              <div
                ref={previewRef}
                className="relative overflow-hidden card-shadow max-h-[70vh]"
                style={{
                  aspectRatio: `${aspect}`,
                  backgroundColor: "#1a1a1a",
                  width: aspect < 1 ? "auto" : "100%",
                  height: aspect < 1 ? "70vh" : "auto",
                  maxWidth: "100%",
                }}
              >
